    ...
    extend: {
      colors: {
        ...
        gray: {
          ...
          100: '#f3f4f6',  // background-tertiary
          200: '#e5e7eb',  // border-color
          300: '#d1d5db',
          400: '#9ca3af',  // secondary-light
          500: '#6b7280',  // secondary-color, text-muted
          600: '#4b5563',
      ...
      borderRadius: {
        'soft': '0.5rem',      // 8px - consistent with var(--radius-base)
        'soft-md': '0.75rem',  // 12px - consistent with var(--radius-md)
        'soft-lg': '1rem',     // 16px - consistent with var(--radius-lg)
        'soft-xl': '1.5rem',   // 24px - consistent with var(--radius-xl)
      },
      spacing: {
        '18': '4.5rem',
        '88': '22rem',
